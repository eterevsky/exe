...
# %bb.0:
	...
	movq	%rax, %rdx
	leaq	"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@"(%rip), %rcx
	callq	fputs
	xorl	%eax, %eax
	addq	$40, %rsp
	retq
...
# %bb.0:
	...
	retq
                                        # -- End function
	.section	.rdata,"dr",discard,"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@"
	.globl	"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@" # @"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@"
"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@":
	.asciz	"Hello, world!\n"
